"""
Django settings for Ingenieria_GPP project.
...
SECRET_KEY = '9x9b@bpxc(lbl#d8t*cu6uge)=tjn4l8t4@cgjlr@6a!1ctk%^'
...
ROOT_URLCONF = 'Ingenieria_GPP.urls'
...
WSGI_APPLICATION = 'Ingenieria_GPP.wsgi.application'
